...
namespace Ags.Web.Framework.UI.Paging
{
    /// <summary>
     ...
     public partial class Pager : IHtmlContent
    {
        ...
        public virtual string GenerateHtmlString()
		{
            ...
            if (showTotalSummary && (model.TotalPages > 0))
            {
                ...
                links.Append(string.Format("Sayfa {0} of {1} {2} Toplam", model.PageIndex + 1, model.TotalPages, model.TotalItems));
                links.Append("</li>");
            }
            if (showPagerItems && (model.TotalPages > 1))
            {
                if (showFirst)
                {
                    ...
                    {
                        links.Append(CreatePageLink(1, "ilk", firstPageCssClass));
                    }
                }
                if (showPrevious)
                {
                    ...
                    {
                        links.Append(CreatePageLink(model.PageIndex, "Son", previousPageCssClass));
                    }
                }
                ...
                if (showNext)
                {
                    ...
                    {
                        links.Append(CreatePageLink(model.PageIndex + 2, "Sonraki", nextPageCssClass));
                    }
                }
                if (showLast)
                {
                    ...
                    {
                        links.Append(CreatePageLink(model.TotalPages, "Önceki", lastPageCssClass));
                    }
                }
            }
        ...
        protected virtual string CreateDefaultUrl(int pageNumber)
		{
		  ...
		  IWebHelper webHelper = ServiceProviderFactory.ServiceProvider.GetService<IWebHelper>();
