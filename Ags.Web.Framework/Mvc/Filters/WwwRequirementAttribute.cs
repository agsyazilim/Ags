    ...
    public class WwwRequirementAttribute : TypeFilterAttribute
    {
        ...
        private class WwwRequirementFilter : IAuthorizationFilter
        {
            ...
            protected void RedirectRequest(AuthorizationFilterContext filterContext, bool withWww)
            {
                ...
                string urlScheme = $"{_webHelper.CurrentRequestProtocol}{Uri.SchemeDelimiter}";

                //compose start of URL with WWW
                string urlWith3W = $"{urlScheme}www.";

                //get requested URL
                string currentUrl = _webHelper.GetThisPageUrl(true);

                //whether requested URL starts with WWW
                bool urlStartsWith3W = currentUrl.StartsWith(urlWith3W, StringComparison.OrdinalIgnoreCase);
            ...
            public void OnAuthorization(AuthorizationFilterContext filterContext)
            {
                ...
                switch (_seoSettings.WwwRequirement)
                {
                    ...
                    case WwwRequirement.NoMatter:
                        ...
                        break;
                    default:
                        throw new AgsException("Not supported WwwRequirement parameter");
                }
            }
