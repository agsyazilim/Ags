...
namespace Ags.Web.Framework
{
    ...
    public partial class RemotePost
    {
        ...
        /// </summary>
        public RemotePost()
            : this(ServiceProviderFactory.ServiceProvider.GetRequiredService<IHttpContextAccessor>(), ServiceProviderFactory.ServiceProvider.GetRequiredService<IWebHelper>())
        {
        }
