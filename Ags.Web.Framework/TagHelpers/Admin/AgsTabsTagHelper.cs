...
namespace Ags.Web.Framework.TagHelpers.Admin
{
    ...
    /// ags-tabs tag helper
    /// </summary>
    [HtmlTargetElement("ags-tabs", Attributes = IdAttributeName)]
    public class AgsTabsTagHelper : TagHelper
    {
        ...
        public AgsTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            List<AgsTabContextItem> tabContext = new List<AgsTabContextItem>();
            context.Items.Add(typeof(AgsTabsTagHelper), tabContext);

            //get tab name which should be selected
            //first try get tab name from query
            Microsoft.Extensions.Primitives.StringValues tabNameToSelect = ViewContext.HttpContext.Request.Query["tabNameToSelect"];
            ...
            foreach (AgsTabContextItem tabItem in tabContext)
            {
            ...
            string itemClass = "nav-tabs-custom";
            //merge classes
    ...
    /// "ags-tab tag helper
    /// </summary>
    [HtmlTargetElement("ags-tab", ParentTag = "ags-tabs", Attributes = NameAttributeName)]
    public class AgsTabTagHelper : TagHelper
    {
        ...
        /// </summary>
        /// <param name="htmlHelper">HTML helper</param>
        public AgsTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            string tabNameToSelect = context.Items.ContainsKey("tabNameToSelect")
            ...
            //add to context
            List<AgsTabContextItem> tabContext = (List<AgsTabContextItem>)context.Items[typeof(AgsTabsTagHelper)];
            tabContext.Add(new AgsTabContextItem()
            {
    ...
    /// Tab context item
    /// </summary>
    public class AgsTabContextItem
    {
        /// <summary>
        /// Title
        /// </summary>
