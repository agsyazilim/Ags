...
{
    /// <summary>
    /// ags-textarea tag helper
    /// </summary>
    [HtmlTargetElement("ags-textarea", Attributes = ForAttributeName)]
    public class AgsTextAreaTagHelper : TextAreaTagHelper
    {
        ...
        public AgsTextAreaTagHelper(IHtmlGenerator generator) : base(generator)
        {
        }
