...
{
    /// <summary>
    /// ags-delete-confirmation tag helper
    /// </summary>
    [HtmlTargetElement("ags-delete-confirmation", Attributes = ModelIdAttributeName + "," + ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class AgsDeleteConfirmationTagHelper : TagHelper
    {
        ...
        public AgsDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
