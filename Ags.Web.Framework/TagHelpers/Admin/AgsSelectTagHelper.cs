...
{
    /// <summary>
    /// ags-select tag helper
    /// </summary>
    [HtmlTargetElement("ags-select", TagStructure = TagStructure.WithoutEndTag)]
    public class AgsSelectTagHelper : TagHelper
    {
        ...
        public AgsSelectTagHelper(IHtmlHelper htmlHelper)
        {
