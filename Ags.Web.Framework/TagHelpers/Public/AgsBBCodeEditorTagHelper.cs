...
namespace Ags.Web.Framework.TagHelpers.Public
{
    ...
    /// </summary>
    [HtmlTargetElement("ags-bb-code-editor", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class AgsBBCodeEditorTagHelper : TagHelper
    {
        ...
        public AgsBBCodeEditorTagHelper(IWebHelper webHelper)
        {
