...
namespace Ags.Web.Framework.FluentValidation
{
    /// <summary>
    ...
    /// </summary>
    public class AgsValidatorFactory : AttributedValidatorFactory
    {
        /// <summary>
        ...
        public override IValidator GetValidator(Type type)
        {
            ...
            var instance = ServiceProviderFactory.ServiceProvider.GetRequiredService(validatorAttribute.ValidatorType);
