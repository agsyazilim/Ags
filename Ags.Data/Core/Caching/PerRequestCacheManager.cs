...
// ***********************************************************************
// <copyright file="PerRequestCacheManager.cs" company="Nop Solutions, Ltd">
...
namespace Ags.Data.Core.Caching
{
    ...
    public partial class PerRequestCacheManager : ICacheManager
    {
        ...
        /// </summary>
        /// <returns>IDictionary&lt;System.Object, System.Object&gt;.</returns>
        ...
        public virtual T Get<T>(string key, Func<T> acquire, int? cacheTime = null)
        {
            ...
            if (result != null && (cacheTime ?? AgsCachingDefaults.CacheTime) > 0)
                items[key] = result;
        ...
        public virtual void RemoveByPattern(string pattern)
        {
            ...
            List<string> matchesKeys = items.Keys.Select(p => p.ToString()).Where(key => regex.IsMatch(key)).ToList();
