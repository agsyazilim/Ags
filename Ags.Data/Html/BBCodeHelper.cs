...
using Ags.Data.Html.CodeFormatter;
...
namespace Ags.Data.Html
{
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                bool newWindow =  ServiceProviderFactory.ServiceProvider.GetRequiredService<StoreInformationSettings>().BbcodeEditorOpenLinksInNewWindow;
