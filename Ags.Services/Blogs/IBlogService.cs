...
namespace Ags.Services.Blogs
{
    ...
    public partial interface IBlogService
    {
        ...
        /// <returns>Blog posts</returns>
        IPagedList<BlogPost> GetAllBlogPosts(int customerId = 0,
        ...
        IPagedList<BlogPost> GetAllBlogPostsByTag(int storeId = 0,
             string tag = "", int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false);
        ...
        IList<BlogPostTag> GetAllBlogPostTags(int customerId,  bool showHidden = false);
