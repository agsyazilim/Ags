...
namespace Ags.Services.Logging
{
    ...
    public partial class DefaultLogger : ILogger
    {
        ...
        private readonly StoreInformationSettings _commonSettings;
        ...
        public DefaultLogger(StoreInformationSettings commonSettings,
            ...
            int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            PagedList<Log> log = new PagedList<Log>(query, pageIndex, pageSize);
            return log;
        }
        ...
        public virtual IList<Log> GetLogByIds(int[] logIds)
        {
            ...
            IQueryable<Log> query = from l in _logRepository.Table
                        where logIds.Contains(l.Id)
                        select l;
            List<Log> logItems = query.ToList();
            //sort by passed identifiers
            List<Log> sortedLogItems = new List<Log>();
            foreach (int id in logIds)
            {
                Log log = logItems.Find(x => x.Id == id);
                if (log != null)
