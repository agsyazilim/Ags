    ...
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        public virtual bool IsMobileDevice()
        {
            ...
            try
            {
                ...
                string userAgent = _httpContextAccessor.HttpContext.Request.Headers[HeaderNames.UserAgent].ToString();
                ...
                bool mobile = b.IsMatch(userAgent) || v.IsMatch(userAgent.Substring(0, 4));
                return mobile;
            }
            catch
            {
