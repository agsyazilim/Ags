...
namespace Ags.Services.Media
{
    ...
    public partial interface IPictureService
    {
       ...
       /// <returns>Picture URL</returns>
        ...
        /// <returns></returns>
        IList<Picture> GetPictureByNewsItemId(int newsItemId, int recordsToReturn = 0);
        /// <summary>
        ...
        /// <param name="recordsToReturn"></param>
        /// <returns></returns>
        IList<Picture> GetPictureBySliderId(int sliderId, int recordsToReturn = 0);
        /// <summary>
        ...
        /// <param name="recordsToReturn"></param>
        /// <returns></returns>
        IList<Picture> GetPictureByGalleryId(int galleryId, int recordsToReturn = 0);
        ...
        string GetCategoriThumbUrl(string thumbFileName, string storeLocation = null);
        /// <summary>
