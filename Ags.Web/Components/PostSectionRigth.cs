...
{
    public class PostSectionRigthViewComponent : AgsViewComponent
    {
        private readonly IPictureService _pictureService;
        private readonly ISectionService _sectionService;
        private readonly IAdvertisementService _advertisementService;

        public PostSectionRigthViewComponent(IPictureService pictureService, ISectionService sectionService, IAdvertisementService advertisementService)
        {
