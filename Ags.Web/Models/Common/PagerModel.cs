namespace Ags.Web.Models.Common
{
    public partial class PagerModel
    {
        ...
        {
            get { return (!string.IsNullOrEmpty(currentPageText)) ? currentPageText : "Aktif"; }
            set
            {
