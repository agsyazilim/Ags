...
namespace Ags.Web.Areas.Admin.Factories
{
    ...
    public partial interface IBlogModelFactory
    {
        ...
        BlogContentModel PrepareBlogContentModel(BlogContentModel blogContentModel, int? filterByBlogPostId,int customerId=0);
        ...
        BlogPostListModel PrepareBlogPostListModel(BlogPostSearchModel searchModel,int customerId=0);
