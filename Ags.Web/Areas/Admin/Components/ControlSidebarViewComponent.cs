...
{
    public class ControlSidebarViewComponent : AgsViewComponent
    {
        ...
        {
            string basePath = Directory.GetCurrentDirectory() + @"\wwwroot\files\";
            string baseExtension = @".html";
            string absoluteFilePath = basePath + filepath + baseExtension;
